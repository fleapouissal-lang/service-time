  ...
  return (
    <section className="mx-auto w-[90%] max-w-[1200px] py-16">
      <div className="mb-10 flex items-end justify-between gap-4">
        <div>
          <p className="text-sm font-semibold text-[#94D4B9]">المواقع</p>
          <h2 className="mt-2 text-3xl font-bold">ورش Service Time في الرياض</h2>
          <p className="mt-3 max-w-2xl text-base leading-8 text-muted">
            اعثر على أقرب ورشة أو اطلب ورشة متنقلة تصل إليك.
          </p>
        </div>
        <Link
          href="/locations"
