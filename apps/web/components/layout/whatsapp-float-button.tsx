...
import { shouldShowMobileBottomNav } from "@/lib/mobile-nav-layout";
import {
...
export function WhatsAppFloatButton() {
  ...
  return (
    <a
      ...
      className={cn(
        "fixed z-50 flex size-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_32px_rgba(37,211,102,0.45)] transition-transform hover:scale-105 active:scale-95",
        locale === "ar" ? "left-6" : "right-6",
        showMobileNav
          ? isRequestPage
            ? "max-lg:bottom-[calc(6.5rem+env(safe-area-inset-bottom))]"
