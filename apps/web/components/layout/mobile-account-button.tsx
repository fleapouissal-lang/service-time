...
function AccountSheetLink({
  ...
  return (
    ...
    >
      <Icon className="size-5 shrink-0 text-[#94D4B9]" />
      {label}
    </Link>
  );
}
    ...
    return (
      <div className="grid gap-1">
        <div className="mb-2 flex items-center gap-3 rounded-2xl bg-white/5 px-3 py-3">
          <ProfileAvatar fullName={fullName} avatarUrl={avatarUrl} size="md" />
  ...
  return (
    <div className="grid gap-2">
      <Link
        href="/login"
        onClick={onClose}
        className="flex h-11 items-center justify-center rounded-[20px] bg-[#94D4B9] text-sm font-semibold text-[#050B10]"
      >
        {messages.auth.login}
      </Link>
      <Link
        href="/register"
        onClick={onClose}
        className="flex h-11 items-center justify-center rounded-[20px] border border-[#94D4B9]/40 text-sm font-semibold text-[#94D4B9]"
      >
      ...
      >
        {fullName ? (
          <ProfileAvatar
            ...
            avatarUrl={avatarUrl}
            size="sm"
            className="!size-10 !text-sm ring-2 ring-[#94D4B9]/40"
          />
        ) : (
