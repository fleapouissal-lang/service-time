...
export function RequestWhatsAppFab() {
  ...
  return (
    <a
      ...
      className={cn(
        "fixed z-40 flex size-14 items-center justify-center rounded-full md:hidden",
        "bottom-[calc(4.5rem+env(safe-area-inset-bottom)+0.75rem)] end-4",
        "bg-[#25D366]/85 text-white backdrop-blur-xl",
        "shadow-[0_8px_28px_rgba(37,211,102,0.5)] ring-2 ring-white/25",
