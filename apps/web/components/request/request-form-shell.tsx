...
export function WhatsAppBrandButton({
  href,
  children,
  className,
  onClick,
  ...
  return (
    <a
      ...
      onClick={onClick}
      className={cn(
        "inline-flex h-12 w-full items-center justify-center gap-2.5 rounded-[20px] bg-[#25D366] text-sm font-semibold text-white transition-opacity hover:opacity-90",
        className,
      )}
    >
      {children}
