...
export default async function HomePage() {
  ...
  const { titleBefore, titleHighlight, subtitle, cta } =
    resolveHeroContent(hero);
    ...
    <>
      ...
      <section className="mx-auto w-[90%] max-w-[1200px] py-16">
        <div className="mb-10 flex items-end justify-between gap-4">
          <div>
            <p className="text-sm font-semibold text-primary">خدماتنا</p>
            <h2 className="mt-2 text-3xl font-bold">ماذا نقدم لك؟</h2>
          </div>
          <Link
            href="/services"
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {featured.length > 0 ? (
            ...
            <p className="col-span-full text-muted">
              لا توجد خدمات بعد — قم بتشغيل seed.sql
            </p>
          )}
        </div>
      </section>
